...
Java_io_github_onaiaku_artmoon_nvstream_jni_MoonBridge_init(JNIEnv *env, jclass clazz) {
    (*env)->GetJavaVM(env, &JVM);
    GlobalBridgeClass = (*env)->NewGlobalRef(env, (*env)->FindClass(env, "io/github/onaiaku/artmoon/nvstream/jni/MoonBridge"));
...
Java_io_github_onaiaku_artmoon_nvstream_jni_MoonBridge_startConnection(JNIEnv *env, jclass clazz,
